...
export function DashboardPage() {
  const { areas, despesas, totalPorArea } = useData()
  ...
  // Áreas com orçamento definido para o gráfico de comparação
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center justify-between gap-2">
        ...
        <Button
          variant="outline"
          onClick={() => gerarRelatorioPDF(areas, despesas)}
      ...
      {despesas.length === 0 ? (
        ...
        <>
                ...
                <CardTitle>
                  ...
                  {totalOrcamento > 0 && (
                    <span className="ml-2 text-sm font-normal text-muted-foreground">
                      Total: {formatCurrency(totalGeral)} de {formatCurrency(totalOrcamento)}
                    </span>
                  )}
                </CardTitle>
              </CardHeader>
                  ...
                  >
                    ...
                    <Bar dataKey="total" name="Gasto" radius={[0, 4, 4, 0]}>
                      {areasComOrcamento.map((entry, i) => (
                        <Cell
                          key={i}
                          fill={entry.total > entry.orcamento ? '#dc2626' : entry.cor}
                        />
                      ))}
                    </Bar>
                  </BarChart>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Custo por hectare</CardTitle>
            </CardHeader>
            <CardContent>
